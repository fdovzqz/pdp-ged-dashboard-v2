...
- **Unidades**: 26 meses (2024-01 … 2026-02).
- **Steps**: `extraer-mes-2024-01`, …, `extraer-mes-2026-02` en paralelo vía `Promise.all(monthPromises)`.
- **Dentro de cada step**: por cada día del mes, bucle de `fetchDatamappingForDayChunk` hasta `hasMore === false` (chunks para evitar 524/600s).
